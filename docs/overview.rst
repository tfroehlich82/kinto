...
It can send a notifications to clients using WebSockets or fill a queue of messages
in Redis or execute any custom code of your choice, like for sending emails or pinging a
third-party.
